...
if (is_user_logged_in()) {
    $redirect = novel_get_page_url('user-dashboard') ?: home_url('/');
...
$register_url = novel_get_page_url('register');
$forgot_url   = novel_get_page_url('forgot-password');
?>

<div class="novel-auth-page">
    <div class="novel-auth-overlay"></div>
    <div class="novel-auth-container">
        <div class="novel-auth-card novel-auth-card--login">
            ...
            <h2 class="novel-auth-title">
                <svg class="novel-auth-icon" viewBox="0 0 24 24" width="24" height="24"><path fill="currentColor" d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>
                <?php esc_html_e('ورود به حساب کاربری', 'flavor'); ?>
            </h2>

            <!-- پیام‌ها -->
            <div class="novel-auth-messages" style="display:none;"></div>

            <form id="novel-login-form" class="novel-auth-form" novalidate>
                ...
                <div class="novel-auth-field">
                    ...
                    <div class="novel-auth-password-wrap">
                        <input type="password" id="login-password" name="password" required
                               placeholder="<?php esc_attr_e('رمز عبور', 'flavor'); ?>"
                               autocomplete="current-password">
                        <button type="button" class="novel-auth-toggle-pass" data-target="login-password" aria-label="<?php esc_attr_e('نمایش رمز', 'flavor'); ?>">
                ...
                <!-- مرا به خاطر بسپار + فراموشی -->
                <div class="novel-auth-row">
                    <label class="novel-auth-checkbox">
                        <input type="checkbox" name="remember" value="1">
                        <span class="novel-auth-checkmark"></span>
                        <?php esc_html_e('مرا به خاطر بسپار', 'flavor'); ?>
                    </label>
                    <?php if ($forgot_url) : ?>
                        <a href="<?php echo esc_url($forgot_url); ?>" class="novel-auth-forgot-link">
                            <?php esc_html_e('فراموشی رمز عبور', 'flavor'); ?>
                        </a>
                    <?php endif; ?>
                </div>

                <!-- دکمه ورود -->
                <button type="submit" class="novel-auth-btn novel-auth-btn--primary" id="novel-login-btn">
                    <span class="novel-auth-btn-text"><?php esc_html_e('ورود', 'flavor'); ?></span>
                    <span class="novel-auth-btn-loading" style="display:none;">
                        <span class="novel-spinner"></span>
                        <?php esc_html_e('در حال ورود...', 'flavor'); ?>
                    </span>
                </button>
            </form>
            ...
            <div class="novel-auth-footer">
                <p>
                    <?php esc_html_e('حساب کاربری ندارید؟', 'flavor'); ?>
                    <a href="<?php echo esc_url($register_url ?: '#'); ?>"><?php esc_html_e('ثبت‌نام کنید', 'flavor'); ?></a>
                </p>
            </div>
